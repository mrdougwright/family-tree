...
$(document).ready(function(){
	...
	function kidsFields(){
		var numFields;
		var kidField = "<td><input name='first_name' type='text' placeholder='First Name'></td><td><input name='last_name' type='text' placeholder='Last Name'></td>";
		for (var i = 0; i < 4; i++) {
	...
	function getChildren(){
		...
		var content = "<table><tbody><tr><td>I am <span class='child_name'></span>'s</td></tr><tr><td><input name='parent_role' type='text' placeholder='Mom / Dad'></td></tr><tr><td><span class='child_name'></span> is my</td></tr><tr><td><input name='child_role' type='text' placeholder='Daughter / Son'></td></tr></tbody></table>"
	...
	function otherParents(){
		var children = retrieveData()['children'];
		var content = "<table><tbody><tr><td><span class='child_name'></span> has a</td></tr><tr><td><input name='parent_role' type='text' placeholder='Mom / Dad'></td></tr><tr><td colspan='2'>named</td></tr><tr><td><input name='first_name' type='text' placeholder='First Name'></td><td><input name='last_name' type='text' placeholder='Last Name'></td></tr></tbody></table>"
		for (var x=0; x < children.length;x++){
	...
	$('.role_submit').click(function(){
		if (validNames == false){
			...
			for (var x = 0; x < family.children.length; x++){
				...
				family.children[x]['role'] = $(".kid_role" + x + " input[name='child_role']").val();
    ...
    for (var y = 0;y < family.children.length; y++){
    	...
    	var div = $('.family').append("<div class='member child" + y + "'></div>");
    ...
    for (var i = 0; i < family.parents.length; i++) {
    	...
    	var div = $('.family').append("<div class='member parent" + i + "'></div>");
